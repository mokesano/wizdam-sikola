...
echo "       mysql -u root -p -e \"CREATE DATABASE wizdam_sikola CHARACTER SET utf8mb4;\""
echo ""
echo "  3. Jalankan migrasi database:"
echo "       mysql -u root -p wizdam_sikola < database_schema_full.sql"
echo "       mysql -u root -p wizdam_sikola < database_migration_v2.sql"
echo ""
